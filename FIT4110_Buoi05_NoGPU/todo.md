...
Phần này ghi lại checklist readiness cần kiểm tra trước khi tuyên bố stack sẵn sàng. Xem file checklists/readiness-checklist.md để biết chi tiết và tick vào các mục như:
